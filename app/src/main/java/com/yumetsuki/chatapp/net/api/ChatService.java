...
import com.yumetsuki.chatapp.net.protocol.resp.FriendMessageResponse;
...
public interface ChatService {
    ...
    Observable<CommonResponse<SendChatMessage>> sendMessage(@Body String req);

    @GET("chat/message/all/{username}")
    Observable<CommonResponse<FriendMessageResponse>> getAllHistoryFriendMessage(@Path("username") String username);
